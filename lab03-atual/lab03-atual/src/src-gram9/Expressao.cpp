...
Expressao *Expressao::extrai_expressao(No_arv_parse *no) {
  ...
  // --- ATRIBUIÇÃO E MUTAÇÃO ---
  case 47: return new ExpressaoAtribuicao(no_exp);
...
// --- VALORES E LITERAIS (Encapsulados em ExpressaoValor) ---
  case 95: return new ExpressaoVariavel(no_exp); // ID
